...
<filePath>D:\sih\frontend\src\api\client.js</filePath>
</content>
</invoke>
</tool_calls> (this was truncated) — let me use the proper edit/write flow. I'll write each file with the write tool correctly.</think>

<｜DSML｜tool_calls>
<｜DSML｜invoke name="write">
<｜DSML｜parameter name="content" string="true">// API client — thin axios wrapper over the backend REST /api/v1 surface.
// Envelope shapes: contracts 1/3/5 (upload, jobs, dashboard). All calls
// resolve to the envelope's `data` payload.
